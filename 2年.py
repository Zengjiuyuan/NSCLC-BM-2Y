...
# 读取训练集数据（注意指定编码格式）
train_data = pd.read_csv('train_data_2_year.csv', encoding='utf-8')  # 或 encoding='gbk'
...
# 创建Web应用程序
st.title("2-year survival of NSCLC-BM patients based on Random Forest")
...
if st.button("Predict"):
    ...
    st.write("Probability of 2-year survival is:", f"{probability:.2%}")  # 格式化百分比显示